...
class ImageFilterManager: ImageFilterManagerProtocol {
	...
	init(imageFilter: ImageFilterProtocol = ImageFilter()) {
		...
		sepiaToneFilter = Filter(filter: imageFilter.sepiaToneFilter,
									 ...
									 parametrs: [DefaultParameters(startValue: 0.0, endValue: 1.0, defaultValue: 0.3)])
		...
		colorControlsFilter = Filter(filter: imageFilter.colorControlsFilter,
										 ...
										 parametrs: [DefaultParameters(startValue: 0.0, endValue: 1.0, defaultValue: 0.0), 		DefaultParameters(startValue: 0.0, endValue: 100.0, defaultValue: 5.0),
													DefaultParameters(startValue: 0.0, endValue: 1.0, defaultValue: 1.0)])

		edgesFilter = Filter(filter: imageFilter.edgesFilter,
								 imageModel: Image(image: UIImage(named: "edges"), description: "Edges"),
								 parametrs: [DefaultParameters(startValue: 0.0, endValue: 100.0, defaultValue: 20.0)])
		...
		gaussianBlurFilter = Filter(filter: imageFilter.gaussianBlurFilter,
										...
										parametrs: [DefaultParameters(startValue: 0.0, endValue: 100.0, defaultValue: 2.5)])
		...
		spotColorFilter = Filter(filter: imageFilter.spotColorFilter,
									 ...
									 parametrs: [DefaultParameters(startValue: 0.0, endValue: 1.0, defaultValue: 1),
												 DefaultParameters(startValue: 0.0, endValue: 1.0, defaultValue: 1),
												 DefaultParameters(startValue: 0.0, endValue: 1.0, defaultValue: 1)])
