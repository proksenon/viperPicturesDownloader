...
protocol NewImageFilterManagerProtocol {
	func applyFilter(image: UIImage?, parameters: NewFilterParameters?)-> UIImage?
}

class NewImageFilterManager: NewImageFilterManagerProtocol {
